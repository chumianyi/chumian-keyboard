...
import com.chumian.ime.inputlogic.PrivateCommandPerformer;
...
import com.chumian.ime.utils.NgramContextUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.chumian.ime.common.Constants.UnicodeSurrogate
